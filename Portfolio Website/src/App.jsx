      ...
      >
        ...
        <motion.div variants={itemVariants}
          ...
          >
            ...
            >
              <p className="text-sm text-slate-400 leading-relaxed" >Drop me a message if you have any questions or want to contact me.
              </p>

              <a href={`mailto:${personalInfo.email}`} className="w-full bg-green-500/10 border border-green-500/20 hover:border-green-500/50 text-green-400 hover:text-white font-medium py-2 rounded-lg text-center transition-all duration-300">
              Send E-mail
              </a>
            </div>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-3">
            ...
            <motion.li key={i}
              ...
              >
                <span className="p-2 roudned-lg bg-white/5 group-hover:bg-white/10 transition duration-300 group-hover:scale-110">
                  <social.icon size={18}/>
                </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-400">
            {achievements.map((ach, i) => (
              ...
              >
                ...
                <h3 className="mt-1 font-medium text-white/90">{ach.title}
                </h3>
